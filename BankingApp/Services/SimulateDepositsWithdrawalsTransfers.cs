...
public class SimulateDepositsWithdrawalsTransfers
{
    public static BankCustomer SimulateActivityDateRange(DateOnly startDate, DateOnly endDate, BankCustomer bankCustomer)
    {
        ...
        DateOnly firstDayFirstFullMonth = new(currentDate.Year, currentDate.Month, 1);
        DateOnly lastDayOfFirstFullMonth = new(currentDate.Year, currentDate.Month, DateTime.DaysInMonth(currentDate.Year, currentDate.Month));
        DateOnly firstDayLastMonth = new(endYear, endMonth, 1);
        DateOnly lastDayOfLastMonth = new(endYear, endMonth, DateTime.DaysInMonth(endYear, endMonth));
    ...
    private static BankCustomer SimulateActivityForPeriod(DateOnly startDate, DateOnly endDate, BankCustomer bankCustomer)
    {
        ...
        DateOnly rentDueDate = new(startDate.Year, startDate.Month, 1);
        ...
        DateOnly dateFinalDayOfMonth = new(endDate.Year, endDate.Month, DateTime.DaysInMonth(endDate.Year, endDate.Month));
